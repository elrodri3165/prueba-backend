...
<script>
    ...
    function AbrirModalLoading(){
        var modal = new bootstrap.Modal(document.getElementById('modalLoading'));
        $('#boton').attr("disabled", "disabled");
        modal.show();
    }
    
</script>
<script src="{ruta}static/js/validacion.js"></script>
<script src="{ruta}static/js/validarpassword.js?{version}" type="text/javascript"></script>